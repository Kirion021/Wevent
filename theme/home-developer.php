				...
				<nav class="navbar navbar-default" role="navigation">
					<div class="container">
						...
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="home-developer.php"><img class="img-responsive" src="img/logo.png" alt="Logo" /></a>
						</div>
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="insertm.php">Insert Merchandise</a></li>
                                <li><a href="inserte.php">Insert Events</a></li>
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">Menu <span class="caret"></span></a>
									<ul class="dropdown-menu" role="menu">
		
										
										<li><a href="merch-dev.php">Store</a></li>
                                        <li><a href="home-developer.php">Main Page</a></li>
									</ul>
								</li>
							</ul>
						</div><!-- /.navbar-collapse -->
					...
					<div class="row">
						<div class="col-md-4 col-sm-4">
							...
							<div class="event-item">
								...
								<!-- heading -->
								<h4><a href="merch-dev.php">Hammersonic</a></h4>
								<!-- sub text -->
							...
							<a href="merch-dev.php">Enter shop here</a>
						</div>
						<div class="col-md-4 col-sm-4">
							<!-- event item -->
							<div class="event-item">
								...
								<!-- heading -->
								<h4><a href="merch-dev.php">Comifuro 2020</a></h4>
								<!-- sub text -->
						...
						<div class="col-md-4 col-sm-4">
							...
							<div class="event-item">
								...
								<!-- heading -->
								<h4><a href="merch-dev.php">Head in the clouds</a></h4>
								<!-- sub text -->
							...
							</div><a href="merch-dev.php">Enter shop here</a>
						</div>
					</div>
				</div>
			</div>
